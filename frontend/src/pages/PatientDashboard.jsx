          ...
          {doctors.map(({ doctor, appointments }) => (
            <div key={doctor._id} className="border rounded-lg p-4">
              <div className="flex items-center space-x-4 mb-4">
                {doctor.profilePhoto ? (
                  <img
                    src={`${import.meta.env.VITE_API_URL}/uploads/${doctor.profilePhoto.replace(/^\/uploads\//, '')}`}
                    alt={doctor.name}
          ...
          <div>
            ...
            <div className="mb-4 flex justify-center">
              {photoPreview ? (
                ...
                <img
                  src={`${import.meta.env.VITE_API_URL}/uploads/${user.profilePhoto.replace(/^\/uploads\//, '')}`}
                  alt="Current profile"
